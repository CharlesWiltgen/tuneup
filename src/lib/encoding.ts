...
const LOSSY_FORMATS = ["mp3", "ogg"]; // Known lossy-only formats
const AMBIGUOUS_FORMATS = ["m4a", "mp4"]; // May be AAC (lossy) or ALAC (lossless) — inspected via audioProperties.isLossless
